...
yystate(20, [10|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line+1, Tlen+1, 4, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 90 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 94 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 92 ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/sgf_lexer.xrl", 7).
yyaction_0(TokenLine) ->
     { token, { game_tree_start, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/sgf_lexer.xrl", 8).
yyaction_1(TokenLine) ->
     { token, { game_tree_end, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/sgf_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { node_start, TokenLine } } .

-compile({inline,yyaction_3/2}).
-file("src/sgf_lexer.xrl", 10).
yyaction_3(TokenChars, TokenLine) ->
     { token, { propident, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/sgf_lexer.xrl", 11).
yyaction_4(TokenChars, TokenLine) ->
     { token, { propvalue, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/0}).
-file("src/sgf_lexer.xrl", 12).
yyaction_5() ->
     skip_token .

-compile({inline,yyaction_6/2}).
-file("src/sgf_lexer.xrl", 13).
yyaction_6(TokenChars, TokenLine) ->
     { token, { eof, TokenLine, TokenChars } } .
